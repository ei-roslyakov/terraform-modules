...
variable "enable_cw" {
  type        = bool
  default     = true
  description = "Set to false to prevent the module from creating any cw resources"
}
variable "zone_id" {
  type        = string
  default     = ""
...
variable "cloudwatch_alarm_actions_ok" {
  type        = list(string)
  default     = []
  description = "Actions for cloudwatch alarms. e.g. an SNS topic"
}

variable "cloudwatch_alarm_actions_alarm" {
  type        = list(string)
  default     = []
  description = "Actions for cloudwatch alarms. e.g. an SNS topic"
}
