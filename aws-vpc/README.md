...
| <a name="input_create_vpc"></a> [create\_vpc](#input\_create\_vpc) | Set to false to prevent the module from creating any resources | `bool` | `true` | no |
...
| <a name="input_name"></a> [name](#input\_name) | Name VPC | `string` | `""` | no |
...
| <a name="output_vpc_id"></a> [vpc\_id](#output\_vpc\_id) | The the VPC id |
<!-- END_TF_DOCS -->
